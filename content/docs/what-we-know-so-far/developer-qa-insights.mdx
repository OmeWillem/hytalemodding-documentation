...
- **Default**: Game uses stamina (not mana)
- **Moddable**: Can add mana system via mods
...
- **Future Changes**: May change further post-launch
- **Current Limitation**: Not fully documented yet

## Development Philosophy

### Team Culture

- **Small Team**: Maintains a close-knit group
- **Hiring Freeze**: Until after launch
- **Unique Organization**: Very specific organizational style vulnerable to over-hiring
- **Slow Growth**: Only hire when there are serious needs

### Base Game Priority

- **Core Focus**: Adventure mode (Orbis) is top priority
- **Modding Integration**: Modding systems built alongside base game
- **Co-Existence**: Base game and modding capabilities build off each other
- **Long-Term Support**: Determined to keep adventure mode updated long-term

### Community Relationship

- **Listening**: Actively looking for community feedback
- **Storm Response**: If community bands together on issues, developers will listen
- **Overcoming Limitations**: Started as Hypixel minigame network wanting to overcome creative limitations
- **Creative Freedom**: Solving problems to enable creativity without restrictions

## Legal and Licensing

### EULA and Terms

- **Comprehensive EULA**: Will cover all applicable terms
- **Nuanced Terms**: More detailed than simple yes/no answers
- **Contributor Compensation**: Working on fair compensation for community contributors
- **Details Pending**: Final legal details still being finalized

### Pre-Orders

- **Coming Soon**: Pre-orders launching soon
- **Legal Approval**: In final stages of legal approval
- **Release Date**: Stay tuned for release date announcement

## Timeline Expectations

The developers emphasized that players "don't need much patience anymore" and to "stay tuned for the release date announcement." The team is focused and working hard to deliver Hytale.
